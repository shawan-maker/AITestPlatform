...
async def main():
    ...
    # 初始化rag对象
    await rag_manager.init_rag("project02")
    # 2、往rag对象中插入文档
    # （2.1）往rag对象中插入文档（字符串格式）   ———— 增强RAG后ainsert()方法不能再使用了
    await rag_manager.add_document("./document/tester.md")
    ...
    # await rag_manager.load_document("./document/picture-desc.pdf")
    # # 3、查询rag对象中的内容
    # （3.1）普通文本内容检索
    ...
    # await rag_manager.query_multimodal("请根据图片中的内容描述，给出一个完整的环境搭建过程。","./document/setup_env.jpg")
