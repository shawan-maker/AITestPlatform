    ...
    <SplitView v-else :initial-width="300" :min-width="240" :max-width="420" :drawer-title="t('page.functional.allCases')">
      ...
      <template #right>
        ...
        >
          ...
          <AppTableColumn v-if="canEdit" actions :label="t('common.actions')" variant="fixed" fixed="right" :button-labels="[t('common.edit'), t('page.functional.copy'), t('common.delete')]" align="center">
            <template #default="{ row }">
